            ...
            try
            {
                ...
                using (var context = new QMEntities())
                {
                    ...
                    if (WorkGroupReportBOList.Count > 0)
                    {
                        ...
                        var insertQuery = context.InsertReport(rgBO.ReportGeneratedFileName, rgBO.CreatedOn, rgBO.CreatedBy, rgBO.MethodofCreation, rgBO.ReportGeneratedFullPath, rgBO.ReportLocation);
